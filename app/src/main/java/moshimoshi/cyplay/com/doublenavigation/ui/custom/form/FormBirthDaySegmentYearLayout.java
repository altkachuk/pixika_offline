...
public class FormBirthDaySegmentYearLayout extends FormDateAutoFillLayout {

    public FormBirthDaySegmentYearLayout(Context context) {
        this(context, null);
    }

    public FormBirthDaySegmentYearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FormBirthDaySegmentYearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    public int getLayoutId() {
        return R.layout.form_date_fill_segment_year;
    }
